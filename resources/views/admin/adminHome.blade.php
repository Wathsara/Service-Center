                                        ...
                                        <div class="table-responsive table-sales">
                                            <table class="table">
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="flag">
                                                            <img src="https://demos.creative-tim.com/material-dashboard-pro/assets/img/flags/US.png" </div>
                                                    </td>
                                                    <td>USA</td>
                                                    <td class="text-right">
                                                        2.920
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="flag">
                                                            <img src="https://demos.creative-tim.com/material-dashboard-pro/assets/img/flags/DE.png" </div>
                                                    </td>
                                                    <td>Germany</td>
                                                    <td class="text-right">
                                                        1.300
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="flag">
                                                            <img src="https://demos.creative-tim.com/material-dashboard-pro/assets/img/flags/AU.png" </div>
                                                    </td>
                                                    <td>Australia</td>
                                                    <td class="text-right">
                                                        760
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="flag">
                                                            <img src="https://demos.creative-tim.com/material-dashboard-pro/assets/img/flags/GB.png" </div>
                                                    </td>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="flag">
                                                            <img src="https://demos.creative-tim.com/material-dashboard-pro/assets/img/flags/RO.png" </div>
                                                    </td>
                                                    <td>Romania</td>
                                                    <td class="text-right">
                                                        600
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="flag">
                                                            <img src="https://demos.creative-tim.com/material-dashboard-pro/assets/img/flags/BR.png" </div>
                                                    </td>
                                                    <td>Brasil</td>
                                                    <td class="text-right">
                                                        550
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="card card-product">
                            <div class="card-header card-header-image" data-header-animation="true">
                                <a href="#pablo">
                                    <img class="img" src="https://demos.creative-tim.com/material-dashboard-pro/assets/img/card-2.jpg">
                                </a>
                            </div>
                            <div class="card-body">
                    ...
                    <div class="col-md-4">
                        <div class="card card-product">
                            <div class="card-header card-header-image" data-header-animation="true">
                                <a href="#pablo">
                                    <img class="img" src="https://demos.creative-tim.com/material-dashboard-pro/assets/img/card-3.jpg">
                                </a>
                            </div>
                            <div class="card-body">
                                <div class="card-actions text-center">
                    ...
                    <div class="col-md-4">
                        <div class="card card-product">
                            <div class="card-header card-header-image" data-header-animation="true">
                                <a href="#pablo">
                                    <img class="img" src="https://demos.creative-tim.com/material-dashboard-pro/assets/img/card-1.jpg">
                                </a>
                            </div>
                            <div class="card-body">
                                <div class="card-actions text-center">
